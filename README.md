...
For Windows x64, the release also includes an unsigned portable build: `codexhub-companion-windows-x64-v0.3.1.zip`. Extract it and run `CodexHub Companion.exe`.
...
- `codexhub-server-v0.3.1.zip`
- `codexhub-windows-agent-v0.3.1.zip`
- `codexhub-linux-agent-v0.3.1.zip`
- `codexhub-macos-agent-v0.3.1.zip`
- `codexhub-android-twa-v0.3.1.zip`
- `codexhub-companion-v0.3.1.zip`
- `codexhub-companion-windows-x64-v0.3.1.zip`
- `codexhub-source-v0.3.1.zip`
...
Windows x64 可以直接下载未签名便携版：`codexhub-companion-windows-x64-v0.3.1.zip`。解压后运行 `CodexHub Companion.exe`。
